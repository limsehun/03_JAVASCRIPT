...
btn1.addEventListener("click",()=>{
    ...
    // 존재하는 key에새로운 값 대입 ==> 값 덮어쓰기
    product.price = 2000;
    console.log(product);

    //4. 객체에 새로운 K:V(key value) 추가하기
    // -> 객체명.새로운key = 새로운value
    //    또는 객체명["새오룬key"]= 새로운value
...
btn2.addEventListener("click", () => {
    ...
    /*
        ...
        여기서의 this == 이벤트가 발생한 요소(클릭된 button)
...
checkJSON.addEventListener("click", () => {
  ...
  //JSON 생성 (JS 객체오양의 문자열)
  const json2='{"menu":"김밥","가격":4000}';
  console.log("json2확인:",json2, typeof json2);
