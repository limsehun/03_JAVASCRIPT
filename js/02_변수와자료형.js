...
function scopeTest2(){
  ...
  if(1 == 1){ // 1과 1이 같다면 if {} 수행
    ...
    fn2 = "변경된 fn2";
    // [좁은 범위의 데이터를 넓은 범위에서 사용할 수 있게하는 방법]
    //if{}내부(좁은범위)에서
  ...
  console.log("if tlfgod gn temp, temp");//123
...
function typeCheak()
{
 ...
 /* string(문자열) : "" 또는 '' 내부에 작성된 값 */
  ...
  console.log("phone : ", phone, typeof phone);
   ...
   console.log("age",age, typeop age );
   console.log("heighe",heigh, typeop heigh );
   console.log("sight",agsighte, typeop sight );
  ...
  console.log("false : ", false, typeof false);
   ...
   //1)배열 : 변수의 묶음
    const numbers = [10,20,30]; //배열생성

    console.log("numbers : ",  numbers,  typeof numbers);

  // 배열에 저장된 값을 하나씩 꺼냈을 때의 타입 검사
  console.log("number 배열의 값 중 0 번째 : ,numbers");
  console.log("number 배열의 값 중 0 번째 : ,numbers");
  console.log("number 배열의 값 중 0 번째 : ,numbers");
  console.log("number 배열의 값 중 0 번째 : ,numbers");
  console.log("number 배열의 값 중 0 번째 : ,numbers");
