/* 매개 변수(parameter), 전달 인자(aegument) */
const input1 = document.querySelector("#input1");
const btn1 = document.querySelector("#btn1");

//절달 받은 값이 양수/음수/0 인지 구분해서 출력하는 함수
...
btn6.addEventListener("click", function(){ // 익명함수
    ...
    //요즘 함수 정의 방법 트렌드(function만 없으면 ㅋㅋ)
...
// 화살표 함수 기본 형태
arrows[0]./*<- name = arrows 의 첫번째 */addEventListener("click",()=>{
...
arrows[2].addEventListener("click",()=>{
    ...
    //함수 정의 부분이 return한 줄 --> {return}생략 가능
    const minusFn = (a,b) => { return a-b; }

    alert(minusFn(10,3)); //7

    //매개변수 1개, 정의내용 return 한 줄
